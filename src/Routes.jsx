...
export default function RoutesPath(){
    return(
        <div style={{padding:'20px'}}>
             <h1 >IPTV <sub style={{ fontSize: '20px' }}>V 1.0</sub> Channel List <sub style={{ fontSize: '15px' }}>by<Link to="http://puneetkumar.netlify.app/" target="_blank">Puneet Kumar</Link></sub></h1>
            <Routes >
